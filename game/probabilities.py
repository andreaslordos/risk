...
def calculator(trials):
    def risk(attack,defense,trials):
        ...
        try:
            return1=totalA/attackWins
        except:
            return1=None
        try:
            return2=totalD/defenseWins
        except:
            return2=None

        return (attackWins/trials,defenseWins/trials,return1,return2)
    points=[]
    for u in range(30):
        points.append((u+1,u+1,risk(u+1,u+1,trials)))
